...
export function trainingReducer(state = initialState, action: TrainingActions) {
    switch (action.type) {
        ...
        case START_TRAINING:
            return {
                ...state,
                activeTraining: {...this.availableExercises.find(e => e.id === action.payload)}
            };
        case STOP_TRAINING:
            return {
                ...state,
...
export const getAvaialableTrainings = createSelector(getTrainingState, (state: TrainingState) => state.availableExercises);
